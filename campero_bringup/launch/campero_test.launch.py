...
def launch_setup(context, *args, **kwargs):
        ...
        robot.append(
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    ...
                    + "/launch/campero_gazebo.launch.py"
                ),
                launch_arguments={
                    "mode": mode,
    ...
    base = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            get_package_share_directory("campero_bringup") + "/launch/campero_base.launch.py"
        ),
        launch_arguments={
            "mode": mode,
            "robot_model": robot_model,
    ...
    teleop = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            get_package_share_directory("campero_bringup") + "/launch/campero_teleop.launch.py"
        ),
        launch_arguments={
            "mode": mode,
            "robot_model": robot_model,
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            common.declare_robot_model(["rubber", "mecanum"], "rubber"),
